...
func (s *Server) Start() error {
	...
	logger.Infof("  • GET  /api/equity-history?trader_id=xxx - Trader equity history")
	logger.Infof("  • GET  /api/equity-history-batch?trader_ids=a,b,c - Batch trader equity history")
